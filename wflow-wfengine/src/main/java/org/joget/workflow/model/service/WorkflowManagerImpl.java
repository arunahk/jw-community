...
//    }
    ...
    protected void startActivitiesBasedOnActivitiesTree(String processId, Map<String, Object> tree) {
            ...
            for (int i = 0; i < runningWfActivityList.length; ++i) {
                ...
                if (actMap.containsKey("subflow")) {
                    ...
                    if (subflowId != null) {
                        ...
                        startActivitiesBasedOnActivitiesTree(subflowId, subtree);
                    }
                }
            }
        } catch (Exception ex) {
        ...
        try {
            ...
            if (activitiesTree != null && !activitiesTree.isEmpty()) {
                ...
                if (processStarted != null) {
                    ...
                    startActivitiesBasedOnActivitiesTree(newProcessId, activitiesTree);
