            ...
            success:function(data) {
                ...
                for( var i=0; i<apps.length; i++) {
                    ...
                    for( var j=0; j<userviews.length; j++){
                        ...
                        <c:if test="${isAdmin}">
                            if (!isMarketplace) {
                                content += '<a href="${pageContext.request.contextPath}/web/console/app/' + app.id + '//forms" onclick="return AdminBar.showQuickOverlay(\'${pageContext.request.contextPath}/web/console/app/' + app.id + '//forms\')" class="app-edit smallbutton"><i class="icon-edit"></i> <fmt:message key='adminBar.label.designApp'/></div>';
                            }
                        </c:if>
