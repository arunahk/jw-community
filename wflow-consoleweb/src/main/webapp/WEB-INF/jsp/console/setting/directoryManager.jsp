                            ...
                            <c:if test="${!empty directoryManagerPluginList}">
                                <select name="directoryManagerImpl" id="directoryManagerImpl">
                                    <c:forEach items="${directoryManagerPluginList}" var="plugin">
                                        <c:if test="${plugin.className ne overriddenDmClassName}">
                                            <option value="<c:out value="${plugin.className}"/>"><c:out value="${plugin.i18nLabel}"/> - <c:out value="${plugin.version}"/></option>
                                        </c:if>
                                    </c:forEach>
                                </select>
                                <div>
